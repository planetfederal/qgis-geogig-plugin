...
from versio.tools.layertracking import (addTrackedLayer,
                getTrackingInfoForGeogigLayer, setRef, getTrackedPathsForRepo)
import os
from geogigpy import geogig
from versio.tools.utils import tempFolder, ownerFromRepoPath, userFromRepoPath, \
    nameFromRepoPath, loadLayerNoCrsDialog
from geogigpy.geogigexception import GeoGigException
from versio.tools.layers import resolveLayerFromSource, WrongLayerSourceException
import re
